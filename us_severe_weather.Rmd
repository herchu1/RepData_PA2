...
todollars <- function(ammount, expfactor) {
    if (expfactor %in% c("K","k")) { ammount * 1000 }
    else if (expfactor == c("M","m")) { ammount * 1000000 }
